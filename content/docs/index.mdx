...
```
### Manual Installation
1. Install shadcn drawer component: https://ui.shadcn.com/docs/components/drawer. You need to slightly modify the drawer component.
```ts title="drawer.tsx"
...
const useTransitionPanel = () => {
  ...
  if (context === undefined)
    throw new Error("useTransitionPanel must be used within a TransitionPanel");
